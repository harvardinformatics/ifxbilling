...
ARG IFXUSER_COMMIT=536a3076dcb495fb14e536b3d3ab9dcac388d1bd
...
RUN --mount=type=ssh pip install --upgrade pip && \
    ...
    pip install git+ssh://git@gitlab-int.rc.fas.harvard.edu/informatics/ifxuser.git@${IFXUSER_COMMIT} && \
